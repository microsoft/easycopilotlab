...
![에이전트 사용 방식 — 몰입형 vs 인컨텍스트](../assets/images/m02/immersive-vs-incontext.png)
...
![몰입형 사용](../assets/images/m02/immersive.png)
...
![인컨텍스트 실전 워크플로 — 여러 에이전트를 하나의 대화에서 조합](../assets/images/m02/incontext-workflow.png)
