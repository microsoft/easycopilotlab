...
필요 지식: FAQ.docx, 복리후생가이드.docx, 담당자정보.xlsx
필요 도구: 담당자 문의 전달 Flow
배포 채널: Teams + @호출
```

{: .important }
> 이 설계서는 오늘의 **나침반**입니다. 모듈이 끝날 때마다 꺼내서 "지금 여기를 하고 있구나" 확인하세요. 마지막 모듈(M13)에서 완성합니다.
